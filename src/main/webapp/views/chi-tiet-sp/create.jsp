...
<div class="container">
    ...
    <div class="row py-2">
        <form action="/StoreManager_war_exploded/chi-tiet-sp/insert" method="POST">
            <div class="row md-3">
                <div class="col-md-5">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="giaNhap" class="form-control" minlength="6" min="0" required/>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Giá Bán</label>
                    <input type="number" name="giaBan" class="form-control" minlength="6" min="0" required/>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" name="moTa" id="exampleFormControlTextarea1" rows="3" required></textarea>
                </div>
            </div>
